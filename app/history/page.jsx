...
const Resume = () => {
  ...
  const description =
    "Descubre mi trayectoria profesional, mis experiencias y las habilidades que he adquirido a lo largo de mi carrera como desarrollador web.";
  const image = "/app/opengraph-history.png";
