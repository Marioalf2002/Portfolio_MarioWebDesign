...
const Services = () => {
  ...
  const description =
    "Descubre la gama completa de servicios que MarioWebDesign ofrece: diseño UI/UX, desarrollo Full Stack, optimización SEO y mantenimiento continuo de sitios web. Soluciones a medida para todas tus necesidades digitales.";
  const image = "/app/opengraph-services.png";
