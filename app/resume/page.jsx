...
const about = {
  title: "Sobre mi",
  description:
    "Soy un desarrollador web full stack, con experiencia en tecnologías modernas y escalables. Mi objetivo es ayudarte a llevar tu proyecto al siguiente nivel.",
  info: [
    {
      fieldName: "Nombre",
